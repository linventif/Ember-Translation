...
return [
    ...
    'bans' => [
        ...
        'confirm_unban_title' => 'Confirmer le débanissement',
        'confirm_unban_description' => 'Voulez-vous vraiment débannir l\'utilisateur ?',
        'user_unbanned' => 'Utilisateur Débanni',
        'confirm_remove_ban_title' => 'Confirmer la Suppression',
        'confirm_remove_ban_description' => 'Voulez-vous vraiment supprimer les logs de ce bannisement ?',
        'remove' => 'Supprimer',
        'ban_record_removed' => 'Logs de ce bannisement supprimer',
    ],
    'store' => [
        'credits' => 'Credits',
        'packages' => 'Packs',
    ...
    'profile' => [
        ...
        'last_played' => 'Dernier Sésio,',
        'linked_accounts' => 'Comptes Liés'
        'no_linked_accounts' => 'Aucun Comptes Liés',
    ],
    'notifications' => [
    ...
    'errors' => [
        'maintenance_mode_title' => 'Maintenance en Cours',
        'maintenance_mode_description' => 'Nous sommes actuellement en maintenance. Désolé pour le dérangement.',
